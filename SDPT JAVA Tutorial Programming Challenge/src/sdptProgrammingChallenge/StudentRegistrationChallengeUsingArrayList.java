...
public class StudentRegistrationChallengeUsingArrayList {

	private String fName, midName,  lName,course, section, year;
	private float midterm, fin;
	
	
	public StudentRegistrationChallengeUsingArrayList(String fName, String lName, String course, String section, String year){
		this.fName = fName;
		this.lName = lName;
		this.course = course;
	...
	public StudentRegistrationChallengeUsingArrayList(String fName, String midName,String lName,String course, String section, String year){
		this.fName = fName;
	...
	public StudentRegistrationChallengeUsingArrayList(String fName,String midName, String lName, String course, String section, String year, float mid, float fin){
		this.fName = fName;
		this.midName = midName;
		this.lName = lName;
		this.course = course;
