...
public class StudentObjectSimulation {
	...
	public StudentObjectSimulation(String fName, String lName, String course, String section, String year){
		this.fName = fName;
		this.lName = lName;
		this.course = course;
	...
	public StudentObjectSimulation(String fName, String midName, String lName, String course, String section, String year){
		this.fName = fName;
	...
	public StudentObjectSimulation(String fName, String midName, String lName, String course, String section, String year, float mid, float fin){
		this.fName = fName;
		this.midName = midName;
		this.lName = lName;
		this.course = course;
